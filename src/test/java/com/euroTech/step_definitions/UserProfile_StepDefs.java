...
public class UserProfile_StepDefs {
    ...
    public void the_user_veriyfies_that_add_education_page_is_displayed() {
    ...
    @Then("The user should bu able to verify added education record with {string}")
    public void the_user_should_bu_able_to_verify_added_education_record_with(String shoolName) {
        userProfilePage.verifyLastAddedSchoolRecordWithSchoolName(shoolName);
    }
